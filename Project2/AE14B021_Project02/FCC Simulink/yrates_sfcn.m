function [sys,x0,str,ts]=yrates_sfcn(t,x,u,flag,Y0)

switch flag
case 0 % initialize
 [sys,x0,str,ts]=mdlInitializeSizes(Y0);
case 1 % derivatives
sys = Yrates(t,x,u) ;
case 3 % output
sys = x;
...
function [sys,x0,str,ts]=mdlInitializeSizes(Y0)
